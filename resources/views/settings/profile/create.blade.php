                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="Digite o nome">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <input class="form-control" type="email" name="email" value="{{ old('email') }}" placeholder="Digite o e-mail">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12">
                                            <select name="role_id" class="form-control">
                                                ...
                                                <option value="{{ $group->id }}" {{ ($group->id == old('role_id')) ? 'selected':'' }}>{{ $group->name }}</option>}
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
